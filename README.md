...
- Top 4% (833/22219) in **[Titanic: Machine Learning from Disaster](https://www.kaggle.com/c/titanic)**, an iconic entry-level competition on Kaggle, in 2020/05. This mini project was ***conducted with R***.
- Top 11% (2/19) in the graduate-level course contest for **Data Science** offered by the Department of CS at NCCU. In addition, I got 96 (A+) for this course.
...
This snapshot was taken in 2021/03. The feature "Name" has been deleted at this point. Amid these 10 variables, "survival" is clearly the target and the rest 9 variables are all features. So I had 10 features at the time (2020/05) I did this mini project. 
...
```
Again, notice that this feature doesn't exist in Titanic dataset on Kaggle anymore. Yet it existed in 2020/05, the time I carrying out this mini project. According to a resource on Kaggle, I extracted the title of "Name" only. Then, I observed the cross table of "Survival" & "Title", and categorized "Title" as followed:
